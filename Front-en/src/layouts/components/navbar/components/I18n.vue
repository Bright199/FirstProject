<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('it')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/it.png" alt="it" /> &nbsp;Italian</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
...
export default {
  computed: {
    i18n_locale_img () {
      ...
      else if (locale === 'it') return require('@/assets/images/flags/it.png')
